            ...
            if(user.name===data.name){
                if(user.email===data.email){
                    if(user.password===data.password){
                      localStorage.setItem('token','98400fd8ead1d9ca2748008e6180de20e38dc130eefd449f3ce238c277ab40fa')
                      if(localStorage.getItem('token')==='98400fd8ead1d9ca2748008e6180de20e38dc130eefd449f3ce238c277ab40fa'){
                        navigate("/dashboard")
                      ...
                      alert("ASHE SE DEATILS FILL KRO NA YRR!!!!!")
                    }
                }else{
                  alert("ASHE SE DEATILS FILL KRO NA YRR!!!!!")
                }
